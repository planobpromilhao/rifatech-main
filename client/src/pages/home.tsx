          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
                💛 Rifa Solidária: Com <span className="text-[#000000] font-bold">apenas R$1,00 (UM REAL)</span> você pode salvar o Dudu e ainda concorrer a <span className="text-secondary">um Onix 0KM</span> ou <span className="text-secondary">R$ 100.000,00</span> 💛
              </h2>
