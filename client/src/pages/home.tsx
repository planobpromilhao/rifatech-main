      ...
      <main className="bg-white">
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4 text-center">
            ...
            {/* Seta para baixo */}
            <div className="flex items-center justify-center my-8" data-testid="arrow-divider">
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              {/* Seta para baixo */}
              <div className="flex items-center justify-center mb-8" data-testid="arrow-divider-3">
                <div className="flex-grow border-t border-gray-300"></div>
                <div className="mx-4">
                  <svg 
                    className="w-8 h-8 text-gray-400" 
        ...
        <section className="py-16 bg-accent/10">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              {/* Seta para baixo */}
              <div className="flex items-center justify-center mb-8" data-testid="arrow-divider-4">
                <div className="flex-grow border-t border-gray-300"></div>
                <div className="mx-4">
                  <svg 
                    className="w-8 h-8 text-gray-400" 
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              {/* Seta para baixo */}
              <div className="flex items-center justify-center mb-8" data-testid="arrow-divider-5">
                <div className="flex-grow border-t border-gray-300"></div>
                <div className="mx-4">
                  <svg 
                    className="w-8 h-8 text-gray-400" 
